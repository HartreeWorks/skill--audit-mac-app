...
A Claude Code skill for auditing macOS applications before running them, with focus on apps requesting sensitive permissions.
...
```bash
# Run install
npx skills add HartreeWorks/skill--audit-mac-app
